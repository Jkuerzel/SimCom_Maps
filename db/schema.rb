...
ActiveRecord::Schema[7.1].define(version: 2024_12_10_213154) do
  ...
  create_table "buildings", force: :cascade do |t|
    ...
    t.string "image_link"
    t.integer "robot_demand", default: 1
  end
  ...
  create_table "map_buildings", force: :cascade do |t|
    ...
    t.boolean "robots", default: false, null: false
  end
  ...
  create_table "maps", force: :cascade do |t|
    ...
    t.decimal "operating_profit", precision: 15, scale: 2, default: "0.0"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "username", default: "default_user"
